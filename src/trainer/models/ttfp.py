...
class TTFPModel:
    ...
    def __init__(self, interval: str, commodity_name: str, max_encode_length: int = 60, max_label_length: int = 5):
        ...
        # set interval for bar data, e.g. ONE_MIN, FIVE_MIN, TICK 
        self.max_encode_length = max_encode_length
        # set max_encode_length for lookback window
        self.max_label_length = max_label_length
        # set max_label_length to create label for classification, which is 1 for long, -1 for short, and 0 for neutral after max_label_length bars

        self.n_classes = 3 # number of classes for classification, which is 1 for long, -1 for short, and 0 for neutral
